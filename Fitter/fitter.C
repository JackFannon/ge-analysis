...
const double chi2_min[2] = {1e10, 1e10};
const int x_best[2] = {-1, -1};
const double p_best[2] = {0, 0};

const std::string mc_filename;

float calc_chi2(TH1D * h_data, TH1F * h_mc, double e_min, double e_max, bool plot_flag = false,TH1D * h_smc, bool flag = false){
...
void fitter(std::string data_filename,
    ...
    TH1D* h_data_calib = new TH1F("", "", nbins, e_min, e_max);
