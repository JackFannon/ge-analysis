...
C--------> Convert GeV to MeV
     ...
     &        DETOT3,DETOT4,ESCA
         ...
         CALL HF1(51,DETOT,1.)   !Total Energy Deposit in Ge(for Bi207)
         CALL HF1(52,DETOT,1.)   !Total Energy Deposit in Ge(for Bi207)
         ...
         CALL HF1(510,DETOT5,1.) !E-loss in plastic part of Al Mylar
         CALL HF1(520,DETOT6,1.) !E-loss in Al part of Al Mylar
         CALL HF1(530,DETOT2+DETOT5+DETOT6,1.) !E-loss in inactive total
